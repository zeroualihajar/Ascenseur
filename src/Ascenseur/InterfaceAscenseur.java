...
public class InterfaceAscenseur {

	private JFrame frameAscenseur;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					InterfaceAscenseur window = new InterfaceAscenseur();
					window.frameAscenseur.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	private void initialize() {
		frameAscenseur = new JFrame();
		frameAscenseur.setTitle("Ascenseur");
		frameAscenseur.getContentPane().setBackground(new Color(102, 153, 153));
		frameAscenseur.getContentPane().setForeground(new Color(0, 0, 0));
		frameAscenseur.getContentPane().setLayout(null);
		ImageIcon image14 = new ImageIcon("src/icon/ic.png");
		frameAscenseur.setIconImage(image14.getImage());
		...
		frameAscenseur.getContentPane().add(panel_1);
		
		JPanel panel_2 = new JPanel();
		panel_2.setBackground(new Color(255, 204, 153));
		panel_2.setBounds(25, 23, 503, 4);
		frameAscenseur.getContentPane().add(panel_2);
		...
		frameAscenseur.getContentPane().add(panel_10);
		...
		frameAscenseur.getContentPane().add(principal);
		...
		frameAscenseur.getContentPane().add(panelImm);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Ascenseur asc1 = new Ascenseur(ascenseur1, person);
				Ascenseur as1 = new Ascenseur(ascenseur2, person8);
				asc1.start();
				as1.start();
				...
				ActionListener task = new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						...
						if(i == 80)
						{
							...
							Ascenseur asc2 = new Ascenseur(ascenseur1, person4);
							
							Ascenseur as2 = new Ascenseur(ascenseur2, person7);
						...
						if(i == 160)
						{
							...
							Ascenseur asc3 = new Ascenseur(ascenseur1, person3);
							Ascenseur as3 = new Ascenseur(ascenseur2, person2);
						...
						if(i == 240)
						{
							...
							Ascenseur asc4 = new Ascenseur(ascenseur1, person1);
							Ascenseur as4 = new Ascenseur(ascenseur2, person9);
						...
						if(i == 300)
						{
							...
							Ascenseur asc5 = new Ascenseur(ascenseur1, person5);
							Ascenseur as5 = new Ascenseur(ascenseur2, person10);
		...
		frameAscenseur.getContentPane().add(lblNewLabel_3);
		
	
		
		
		frameAscenseur.setBounds(100, 42, 610, 786);
		frameAscenseur.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
